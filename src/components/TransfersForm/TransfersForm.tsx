  ...
  return (
    <>
      ...
      <div className="grid form-add-player gap-2 p-2 opacity-0 invisible">
        ...
        <select name="transfer-type" id="transfer-type" defaultValue={'default'} className="text-white placeholder-white bg-indigo-950 py-2 px-3 rounded-lg">
          <option value="default" disabled>Selecciona</option>
          <option value="buy">Compra</option>
          <option value="sale">Venta</option>
          <option value="cesion">Cesion</option>
          <option value="cesion-buy">Cesion con opcion de compra</option>
          <option value="cesion-sale">Cesion de venta con opcion de compra</option>
          <option value="end-contract">Fin del contrato</option>
        </select>
